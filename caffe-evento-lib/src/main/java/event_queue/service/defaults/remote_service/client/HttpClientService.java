...
import static event_queue.service.defaults.remote_service.server.HttpServerConstants.*;

/**
 * Created by chris on 7/12/16.
 */
public abstract class HttpClientService extends Service implements EventSink {
    ...
    public HttpClientService(HttpClient client, String host, int port) {
        this.client = client;
        this.host = host;
        this.port = port;
    }
